...
public class WorkoutScheduler {
    ...
    private void createMainView() {
        ...
        restoreButton.setBackground(new Color(0xD7E9E6));
        ...
        buttonsPanel.setBackground(new Color(0xd7e9e6));
        JButton addTaskButton = new JButton("Add Task");
        JButton editTaskButton = new JButton("Edit Task");
        JButton finishTaskButton = new JButton("Finish Task");
        JButton viewTaskButton = new JButton("View Task");

        addTaskButton.setBackground(new Color(0x9CBB89));
        addTaskButton.setForeground(Color.BLACK);

        editTaskButton.setBackground(new Color(0x638262));
        editTaskButton.setForeground(Color.BLACK);

        finishTaskButton.setBackground(new Color(0xD5B1C8));
        finishTaskButton.setForeground(Color.BLACK);

        viewTaskButton.setBackground(new Color(0x416F5D));
        viewTaskButton.setForeground(Color.BLACK);
    ...
    private void switchToAddTaskView() {
        ...
        confirmButton.setBackground(new Color(0x638262));
        confirmButton.setForeground(Color.BLACK);

        cancelButton.setBackground(new Color(0x416F5D));
